<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="{{ (isset($width)) ? $width : 25 }}px" height="{{ (isset($height)) ? $height : 25 }}px"
    viewBox="0 -0.5 17 17" version="1.1"
    >

<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" height="{{ $height ?? 25 }}px"
    width="{{ $width ?? 25 }}px" version="1.1" id="Capa_1" viewBox="0 0 512 512" xml:space="preserve">
    <g>
        <path
            d="M384,448H128c-17.672,0-32,14.328-32,32s14.328,32,32,32h256c17.672,0,32-14.328,32-32S401.672,448,384,448z" />
        <path
